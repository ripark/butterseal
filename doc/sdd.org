...
Perhaps something like the following, untested (and uncompiled) sketch:
#+BEGIN_SRC java
  public class World {
      private static class Route {
          BSMap source, destination;
          Object data;
          ...
          throws BSException
      {
          if(source == null || destination == null) {
              throw new BSException("Source or destination cannot be null.");
          }
      ...
      public Set<BSMap> getMaps<T implements Set<BSMap>>() {
          Set<BSMap> maps = new T<BSMap>();
      ...
      public Set<BSMap> getMaps<T implements Set<BSMap>>(BSMap source) {
          Set<BSMap> maps = new T<BSMap>();
          for(Route r : this.routes)
              if(source = r.source)
                  maps.add(r.destionation);
          return maps;
      }
  }
#+END_SRC
